...
import { TETROMINOS, randomTetrominos } from "../helpers/tetrominos";
...
export const usePlayer = () => {
  ...
  const playerRotate = (stage, dir) => {
    ...
    clonedPlayer.tetromino = rotate(clonedPlayer.tetromino, dir); // Rotate the tetromino matrix by dir times 90 degrees clockwise
